...
export class UIWindowHiddenCommand extends SimpleCommand implements ICommand  {
    ...
    execute(notification: INotification) {
        ...
        if (notification.body instanceof UIWindowNotice) {
            ...
            /*
                ...
                var currentScene = sceneProxy.CurrentScene;

                if (currentScene != null && currentScene.Components.Contains(config))
                {
                    ...
                    {
                        SendNotice(UINoticeKey.SceneHidden, currentScene);
                    }
